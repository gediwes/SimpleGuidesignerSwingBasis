 ...
 *
 */
public class LBTastenLauscherInfo extends LauscherInfo    {
	public static Vector<String> llistener = new Vector<String> ();
	/**
	 * 
	 */
	public LBTastenLauscherInfo() {
		super(Controller.BASISGUILAUSCHER);
		this.setImportString("import basis.*;\n");
		this.setLauscherName("TastenLauscher");		
		String[] meth=new String[1]; 
		meth[0] ="  @Override\n  public void bearbeiteTaste(Komponente k, char t)";
