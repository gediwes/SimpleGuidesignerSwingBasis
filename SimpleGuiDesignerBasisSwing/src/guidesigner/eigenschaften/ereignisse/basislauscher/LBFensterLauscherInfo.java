 ...
 *
 */
public class LBFensterLauscherInfo extends LauscherInfo {
    public static Vector<String> llistener = new Vector<String> ();
	/**
	 * 
	 */
	public LBFensterLauscherInfo() {
		super(Controller.BASISGUILAUSCHER);
		this.setImportString("import basis.*;\n");
		this.setLauscherName("FensterLauscher");		
		String[] meth=new String[1]; 
		meth[0] ="  @Override\n  public void bearbeiteFensterWurdeGeschlossen(Fenster k)";
